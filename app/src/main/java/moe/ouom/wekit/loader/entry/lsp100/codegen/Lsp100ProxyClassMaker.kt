package moe.ouom.wekit.loader.entry.lsp100.codegen

import io.github.libxposed.api.XposedInterface
import moe.ouom.wekit.loader.entry.lsp100.Lsp100HookImpl
import moe.ouom.wekit.loader.entry.lsp100.Lsp100HookWrapper
...
//        fun getWrapperMethod(): Method? = sWrapperMethod
        ...
        private fun getClassNameForPriority(priority: Int): String =
            $$"moe.ouom.wekit.loader.sbl.lsp100.dyn.Lsp100CallbackProxy$$${
                priorityToShortName(
                    priority
                )
            }"
